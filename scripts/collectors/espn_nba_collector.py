#!/usr/bin/env python3
"""
ESPN NBA live score collector.

Polls the ESPN scoreboard API every ~1 second and writes a CSV row
whenever the score, period, or game clock changes.
...
Usage:
    python3 espn_nba_collector.py --event 401859965 --out data/espn_nba_20260608.csv
